...
export class AddComponent implements OnInit {
  ...
  onAddDocSubmit() {
    this.show = true;
    this.msg_text = 'Adding Policy to the Network....';
    this.warn = false;
    this.success = false
    ...
    this.ds.addDoctor(this.model.docID, data).then((r: any) => {
      ...
      this.msg_text += '<br>Policy Added to the Blockchain';
      ...
      this.warn = true
      this.msg_text =
        'Adding Policy Failed<br> <small class="fw-light text-danger"><b>"</b>' +
        this.model.docID +
        '<b>"</b></small><br>Policy might already exist';
      console.log(er);
    })
  }
